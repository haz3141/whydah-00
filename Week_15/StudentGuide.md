...
* [Burger 2: The Sequel](Homework/Instructions/homework_instructions.md)

### Key Activities

* [Simple Sequelize Demo](Tuesday/Activities/03-Chirpy-Sequelize)
* [Setting Up a Sequelize Project with the Sequelize CLI](Tuesday/Activities/06-SequelizeCLI)
* [Converting an ORM App to Use Sequelize](Thursday/Activities/07-ORM-To-Sequelize)
* [Sequelize CREATE and READ](Thursday/Activities/08-Sequelize-Create-Read)
* [Sequelize UPDATE and DELETE](Thursday/Activities/09-Sequelize-Update-Delete)
* [One-to-One, One-to-Many Associations](Saturday/Activities/13-Post-Author-Association)
* [Join Associated Models with Sequelize Queries](Saturday/Activities/14-Post-Author-Joins)
